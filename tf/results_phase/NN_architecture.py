...
transfer_values_train=np.load('transfer_values/VGG16/transfer_values_train.npy')
transfer_values_val=np.load('transfer_values/VGG16/transfer_values_val.npy')
...
def train_net(num_epochs,epoch_ctr=0):
    for i in range(num_epochs):
        ...
        callback_tensorboard = TensorBoard(log_dir='./logs_VGG16/',
                                           histogram_freq=0,
                                           write_graph=False)
        ...
        decoder_model.evaluate_generator(generator=generator_val,steps=200)
        epoch_ctr+=1
